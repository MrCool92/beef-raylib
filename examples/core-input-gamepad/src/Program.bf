        ...
        while (!WindowShouldClose())
        {
            ...
            if (IsGamepadAvailable(0))
            {
                ...
                else if (TextIsEqual(GetGamepadName(0), PS3NameId.CStr()))
                {
                    ...
                    if (IsGamepadButtonDown(0, .Middle)) DrawRectangle(328, 170, 32, 13, .Red);
                    if (IsGamepadButtonDown(0, .MiddleRight)) DrawTriangle(Vector2(436, 168), Vector2(436, 185), Vector2(464, 177), .Red);
